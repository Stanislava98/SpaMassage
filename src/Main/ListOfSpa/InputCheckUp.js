  ...
  return (
    <div>
      <FormControl
        sx={{
          width: 300,
          '& .MuiOutlinedInput-root.Mui-focused .MuiOutlinedInput-notchedOutline': { borderColor: '#dc5b13' },
          '& .MuiOutlinedInput-root:hover .MuiOutlinedInput-notchedOutline': { borderColor: '#dc5b13' },
      ...
      >
        ...
        <StyledSelect
          ...
          input={<OutlinedInput label="Выбрать масла" />}
